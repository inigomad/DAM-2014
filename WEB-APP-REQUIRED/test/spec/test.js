...
(function() {
    ...
    describe('Test', function() {
        ...
        describe('Devuelve vacio si no tiene argumentos', function() {
            it('Sin argumentos', function() {
                assert.equal('', mod.testnumber());
            });
        }); 

        describe('Devuelve vacio si el primer argumento no es un entero', function() {
            it('El primero argumento no es un entero', function() {
                assert.equal('', mod.testnumber('un cesto de gatos',1,3));
            });
        });  

        describe('Devuelve uno si tiene varios argumentos y el primero es un entero', function() {
            it('tiene que devolver 1', function() {
                assert.equal(1, mod.testnumber(1,'un cesto de gatos',1,3));
            });
        });     
